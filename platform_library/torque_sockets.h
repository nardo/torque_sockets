...
void torque_socket_allow_arranged_connections(torque_socket, bool allowed); ///< if true, this socket will arrange connections between hosts connected to this socket.
bool torque_socket_does_allow_arranged_connections(torque_socket); ///< Returns true if this socket will arrange connections between hosts connected to this socket.	
