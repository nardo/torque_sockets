...
public:
	...
	void connect_arranged(interface *connection_interface, const array<address> &possible_addresses, nonce &my_nonce, nonce &remote_nonce, byte_buffer_ptr shared_secret, bool is_initiator, bool requests_key_exchange = false, bool requests_certificate = false)
	{
